...
#             temp = '%.2f' % temp
            ...
            LDRpercentage = 100 - (lightValue / 244) * 100
            ...
            print("Moisture value:", moistureValue, "Moisture percentage:", MSpercentage, "LDR value:",lightValue, "LDR percentage:", LDRpercentage)
